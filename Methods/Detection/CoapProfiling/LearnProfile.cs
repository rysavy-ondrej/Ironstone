...
namespace Ironstone.Analyzers.CoapProfiling
{
    ...
    internal class LearnProfile : IDisposable
    {
        ...
        public void Configuration(CommandLineApplication command)
        {
            ...
            command.OnExecute(() =>
            {
                ...
                if (readOption.HasValue() && writeOption.HasValue())
                {
                    ...
                    LoadAndCompute(profile, readOption.Value(), windowSize, modelKey, flowAggregation);
        ...
        private void LoadAndCompute(CoapProfile profile, string inputFile, double windowSize, CoapResourceAccess.Fields modelKey, FlowKey.Fields flowAggregation = FlowKey.Fields.None) 
        {
