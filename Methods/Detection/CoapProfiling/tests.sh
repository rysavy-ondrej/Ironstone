...
#WINDOW=30
dotnet Ironstone.Analyzers.CoapProfiling.dll Learn-Profile -InputFile=SampleData/coap-test.csv -WriteTo coap30.profile -Aggregate="udp.srcport,udp.dstport" -WindowSize=30
...
# WINDOW=60
dotnet Ironstone.Analyzers.CoapProfiling.dll Learn-Profile -InputFile=SampleData/coap-test.csv -WriteTo coap60.profile -Aggregate="udp.srcport,udp.dstport" -WindowSize=60
...
# WINDOW=90
dotnet Ironstone.Analyzers.CoapProfiling.dll Learn-Profile -InputFile=SampleData/coap-test.csv -WriteTo coap90.profile -Aggregate="udp.srcport,udp.dstport" -WindowSize=90
...
# WINDOW=120
dotnet Ironstone.Analyzers.CoapProfiling.dll Learn-Profile -InputFile=SampleData/coap-test.csv -WriteTo coap120.profile -Aggregate="udp.srcport,udp.dstport" -WindowSize=120
...
# WINDOW=150
dotnet Ironstone.Analyzers.CoapProfiling.dll Learn-Profile -InputFile=SampleData/coap-test.csv -WriteTo coap150.profile -Aggregate="udp.srcport,udp.dstport" -WindowSize=150
...
# WINDOW=180
dotnet Ironstone.Analyzers.CoapProfiling.dll Learn-Profile -InputFile=SampleData/coap-test.csv -WriteTo coap180.profile -Aggregate="udp.srcport,udp.dstport" -WindowSize=180
