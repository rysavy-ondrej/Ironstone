...
namespace Kaitai
{
    ...
    public partial class Lwm2mTlv : KaitaiStruct
    {
        ...
        public Lwm2mTlv(KaitaiStream io, KaitaiStruct parent = null, Lwm2mTlv root = null) : base(io)
        {
            m_parent = parent;
            m_root = root ?? this;
            _parse();
        ...
        public partial class TlvIdentifier : KaitaiStruct
        {
            ...
            public TlvIdentifier(KaitaiStream io, Lwm2mTlv parent = null, Lwm2mTlv root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class TlvLength : KaitaiStruct
        {
            ...
            public TlvLength(KaitaiStream io, Lwm2mTlv parent = null, Lwm2mTlv root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
        ...
        public partial class TlvType : KaitaiStruct
        {
            ...
            public TlvType(KaitaiStream io, Lwm2mTlv parent = null, Lwm2mTlv root = null) : base(io)
            {
                m_parent = parent;
                m_root = root;
                _parse();
